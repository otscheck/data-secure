        ...
        <form method="POST" action="{{ route('employees.store') }}">
            ...
            <div class="grid grid-cols-2 gap-8 mb-4">
                <div class="">
                    ...
                    <input type="text" id="matricule" name="matricule" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="matricule de l'élément">
                </div>
                <div class="">
                    <label for="nom_complet" class="block mb-2 pl-2 text-sm font-medium text-gray-900">Nom complet</label>
                    <input type="text" id="nom_complet" name="nom_complet" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="écrire le nom">
                </div>
                <div class="">
                    <label for="adresse" class="block mb-2 pl-2 text-sm font-medium text-gray-900">Adresse</label>
                    <input type="text" id="adresse" name="adresse" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Adresse civil">
                </div>
                <div class="">
                    <label for="telephone" class="block mb-2 pl-2 text-sm font-medium text-gray-900">Téléphone</label>
                    <input type="text" id="telephone" name="telephone" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="numéro de téléphone">
                </div>
                <div class="">
                ...
                <div class="mb-2">
                    ...
                    <input type="text" id="prime" name="prime" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="prime sur salaire">
                </div>
                <div class="mb-2">
                    <label for="engage_le" class="block mb-2 pl-2 text-sm font-medium text-gray-900">Date de commencement</label>
                    <input type="date" id="engage_le" name="engage_le" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                </div>
                <div class="mb-2">
                    <label for="taille" class="block mb-2 pl-2 text-sm font-medium text-gray-900">Taille</label>
                    <input type="text" id="taille" name="taille" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="(m)">
                </div>
                <div class=""></div>
                <div class="">      
                ...
                <div class="mb-2 col-start-1 col-end-3">                    
                    ...
                    <textarea id="description" name="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="note spécial sur l'agent"></textarea>
                </div>             
            </div>
