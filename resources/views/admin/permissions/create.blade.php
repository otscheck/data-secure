    ...
    <div class="mt-12 max-w-6xl mx-auto">
        ...
        <div class="max-w-md mx-auto bg-gray-100 p-6 mt-12 rounded">
            <form class="space-y-5" method="POST" action="{{ route('admin.permissions.store') }}">
                @csrf
                <div>
                    <label for="nom" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Ajout d'une permission</label>
                ...
                <button type="submit" class="w-full rounded-lg bg-blue-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300">Ajouter une permission</button>
            </form>
        </div>       
